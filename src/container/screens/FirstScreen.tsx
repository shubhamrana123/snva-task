...
<Typography> Depart From</Typography>
<Typography> Going to</Typography>
</Stack>
<Stack  sx={{
display:'flex',
flexDirection:'row',
...
<Typography sx={{textAlign:'center'}} width={'24px'}>{count1}</Typography>
...
{/* <Typography>+</Typography> */}
<Button variant="contained" sx={{width:'10px'}}
onClick={()=>{
if(count2<9){
  setCount2(count2+1)
}
...
<Typography sx={{textAlign:'center'}} width={'24px'}>{count2}</Typography>
<Button variant="contained"
onClick={()=>{
if(count2>0){
  setCount2(count2-1)
...
<Typography sx={{textAlign:'center'}} width={'24px'}>{count3}</Typography>
<Button variant="contained"
onClick={()=>{
if(count3>0){
  setCount3(count3-1)
